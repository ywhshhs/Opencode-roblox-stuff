#!/usr/bin/env node
import { createGoal, listGoals } from "@nyan-works/nyan-memory";
    ...
    switch (command) {
        ...
        case "ls": {
            ...
            for (const g of goals)
                console.log(`[${g.status}] ${g.title}: ${g.description}`);
            break;
        }
        case "create": {
            ...
            if (!title) {
                console.error("Usage: nyan goal create <title> [description]");
                process.exit(1);
            }
