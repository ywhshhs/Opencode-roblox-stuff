...
function withLongCacheRetention(model) {
    return {
        ...model,
        compat: {
            ...model.compat,
...
async function expectLongCacheRetentionAccepted(model, apiKey) {
    const options = {
        apiKey,
        cacheRetention: "long",
        maxTokens: 128,
...
//# sourceMappingURL=anthropic-long-cache-retention-e2e.test.js.map