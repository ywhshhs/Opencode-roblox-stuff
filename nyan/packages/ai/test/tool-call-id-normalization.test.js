...
describe("Tool Call ID Normalization - Live Handoff", () => {
    it.skipIf(!copilotToken || !openrouterKey)("github-copilot -> openrouter should normalize pipe-separated IDs", async () => {
        ...
        const assistantResponse = await completeSimple(copilotModel, {
        ...
        const openrouterResponse = await completeSimple(openrouterModel, {
    ...
    it.skipIf(!copilotToken || !codexToken)("github-copilot -> openai-codex should normalize pipe-separated IDs", async () => {
        const copilotModel = getModel("github-copilot", "gpt-5.2-codex");
        ...
        const codexResponse = await completeSimple(codexModel, {
            systemPrompt: "You are a helpful assistant.",
            messages: [
                userMessage,
                assistantResponse,
...
describe("Tool Call ID Normalization - Prefilled Context", () => {
    ...
    it.skipIf(!openrouterKey)("openrouter should handle prefilled context with long pipe-separated IDs", async () => {
    ...
    it.skipIf(!codexToken)("openai-codex should handle prefilled context with long pipe-separated IDs", async () => {
...
//# sourceMappingURL=tool-call-id-normalization.test.js.map