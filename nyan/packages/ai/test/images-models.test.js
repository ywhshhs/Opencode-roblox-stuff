...
function fakeAuthContext(env) {
    return {
        env: async (name) => env[name],
        fileExists: async () => false,
    };
}
function testImageModel(provider, id) {
    return {
        id,
        name: id,
        api: "test-images",
...
const context = { input: [{ type: "text", text: "a red circle" }] };
describe("ImagesModels", () => {
    ...
    it("builtinImagesModels registers the openrouter provider with its catalog", async () => {
        const models = builtinImagesModels({ authContext: fakeAuthContext({ OPENROUTER_ANYAN_KEY: "or-key" }) });
...
//# sourceMappingURL=images-models.test.js.map