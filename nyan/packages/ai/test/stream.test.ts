...
describe("Generate E2E Tests", () => {
	...
	describe.skipIf(!process.env.DEEPSEEK_ANYAN_KEY)(
	...
	describe.skipIf(!hasCloudflareAiGatewayCredentials() || !process.env.OPENAI_ANYAN_KEY)(
	...
	describe.skipIf(!hasCloudflareAiGatewayCredentials() || !process.env.ANTHROPIC_ANYAN_KEY)(
	...
	describe.skipIf(!process.env.AI_GATEWAY_ANYAN_KEY)(
	...
	describe.skipIf(!process.env.KIMI_ANYAN_KEY)(
	...
	describe.skipIf(!process.env.XIAOMI_ANYAN_KEY)(
	...
	describe.skipIf(!process.env.XIAOMI_TOKEN_PLAN_CN_ANYAN_KEY)(
	...
	describe.skipIf(!process.env.XIAOMI_TOKEN_PLAN_AMS_ANYAN_KEY)(
	...
	describe.skipIf(!process.env.XIAOMI_TOKEN_PLAN_SGP_ANYAN_KEY)(
