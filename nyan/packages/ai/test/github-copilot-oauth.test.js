...
import { getModels } from "../src/compat.js";
import { githubCopilotOAuthProvider, loginGitHubCopilot, refreshGitHubCopilotToken, } from "../src/utils/oauth/github-copilot.js";
...
describe("GitHub Copilot OAuth device flow", () => {
    ...
    it("times out after repeated slow_down responses", async () => {
        ...
        const rejection = expect(loginPromise).rejects.toThrow(/Device flow timed out after one or more slow_down responses/);
...
//# sourceMappingURL=github-copilot-oauth.test.js.map