...
describe("openai-codex cache affinity e2e", () => {
    it.skipIf(!codexToken)("handles SSE requests with aligned cache-affinity identifiers", async () => {
        ...
        expect(response.content.map((block) => (block.type === "text" ? block.text : "")).join("")).toContain("cache affinity e2e success");
    });
});
//# sourceMappingURL=openai-codex-cache-affinity-e2e.test.js.map