...
import { createModels, hasApi } from "../src/models.js";
import { AssistantMessageEventStream } from "../src/utils/event-stream.js";
function testModel(provider, id) {
    return {
        id,
        name: id,
        api: "test-api",
...
function doneMessage(model, text) {
    return {
        role: "assistant",
...
describe("Models runtime", () => {
    ...
    it("refreshes expired oauth credentials and persists the rotated credential", async () => {
        ...
        expect((await credentials.read("p1")).access).toBe("new-token");
    });
    it("rejects with code oauth when refresh fails, preserving the stored credential", async () => {
        ...
        expect((await credentials.read("p1")).access).toBe("old");
    });
...
//# sourceMappingURL=models-runtime.test.js.map