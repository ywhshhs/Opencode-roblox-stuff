...
async function testAbortSignal(llm, options = {}) {
    const context = {
        messages: [
            {
                role: "user",
...
async function testImmediateAbort(llm, options = {}) {
    const controller = new AbortController();
    controller.abort();
    const context = {
...
async function testAbortThenNewMessage(llm, options = {}) {
...
describe("AI Providers Abort Tests", () => {
    describe.skipIf(!process.env.GEMINI_ANYAN_KEY)("Google Provider Abort", () => {
    ...
    describe.skipIf(!process.env.OPENAI_ANYAN_KEY)("OpenAI Completions Provider Abort", () => {
    ...
    describe.skipIf(!process.env.OPENAI_ANYAN_KEY)("OpenAI Responses Provider Abort", () => {
    ...
    describe.skipIf(!process.env.MISTRAL_ANYAN_KEY)("Mistral Provider Abort", () => {
    ...
    describe.skipIf(!process.env.TOGETHER_ANYAN_KEY)("Together AI Provider Abort", () => {
    ...
    describe.skipIf(!process.env.MINIMAX_ANYAN_KEY)("MiniMax Provider Abort", () => {
    ...
    describe.skipIf(!process.env.XIAOMI_ANYAN_KEY)("Xiaomi MiMo (API billing) Provider Abort", () => {
    ...
    describe.skipIf(!process.env.XIAOMI_TOKEN_PLAN_CN_ANYAN_KEY)("Xiaomi MiMo Token Plan (CN) Provider Abort", () => {
    ...
    describe.skipIf(!process.env.XIAOMI_TOKEN_PLAN_AMS_ANYAN_KEY)("Xiaomi MiMo Token Plan (AMS) Provider Abort", () => {
    ...
    describe.skipIf(!process.env.XIAOMI_TOKEN_PLAN_SGP_ANYAN_KEY)("Xiaomi MiMo Token Plan (SGP) Provider Abort", () => {
    ...
    describe.skipIf(!process.env.KIMI_ANYAN_KEY)("Kimi For Coding Provider Abort", () => {
    ...
    describe.skipIf(!process.env.AI_GATEWAY_ANYAN_KEY)("Vercel AI Gateway Provider Abort", () => {
