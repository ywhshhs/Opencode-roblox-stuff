...
describe("openai-completions responseModel", () => {
    ...
    it("surfaces routed chunk.model on responseModel without changing model", async () => {
        ...
        const message = await complete(openRouterAuto(), { messages: [{ role: "user", content: "hi", timestamp: Date.now() }] }, { apiKey: "test" });
...
//# sourceMappingURL=openai-completions-response-model.test.js.map