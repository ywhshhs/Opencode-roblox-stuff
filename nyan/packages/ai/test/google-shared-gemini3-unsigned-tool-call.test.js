...
function makeGemini3Model(api, provider, id = "gemini-3-pro-preview") {
    return {
        id,
...
function makeContext(model, thoughtSignature) {
    const now = Date.now();
    return {
        messages: [
...
//# sourceMappingURL=google-shared-gemini3-unsigned-tool-call.test.js.map