...
function makeModel(allowEmptySignature) {
    return {
        id: "mimo-v2.5-pro",
        name: "MiMo-V2.5-Pro",
...
function makeContext(thinkingSignature) {
    const assistant = {
        role: "assistant",
...
async function capturePayload(model, context) {
    let capturedPayload;
...
//# sourceMappingURL=anthropic-empty-thinking-signature-compat.test.js.map