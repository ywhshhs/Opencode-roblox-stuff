...
describe("Anthropic adaptive thinking model metadata", () => {
    it("marks built-in Anthropic Messages models that use adaptive thinking", () => {
        ...
        expect(flaggedModels).toEqual(flaggedModels.filter((modelId) => /(opus[-.]4[-.][678]|sonnet[-.]4[-.]6|fable[-.]5)/.test(modelId)));
    });
});
//# sourceMappingURL=anthropic-adaptive-thinking-models.test.js.map