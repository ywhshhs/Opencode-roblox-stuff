...
import { anthropicOAuth } from "../src/utils/oauth/anthropic.js";
import { githubCopilotOAuth } from "../src/utils/oauth/github-copilot.js";
import { openaiCodexOAuth } from "../src/utils/oauth/openai-codex.js";
...
describe.sequential("OAuthAuth adapters", () => {
    ...
    it("anthropic refresh exchanges the refresh token and returns a typed credential", async () => {
        vi.stubGlobal("fetch", vi.fn(async () => jsonResponse({ access_token: "new-access", refresh_token: "new-refresh", expires_in: 3600 })));
...
//# sourceMappingURL=oauth-auth.test.js.map