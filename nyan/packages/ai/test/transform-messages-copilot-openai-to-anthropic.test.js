...
function anthropicNormalizeToolCallId(id, _model, _source) {
    return id.replace(/[^a-zA-Z0-9_-]/g, "_").slice(0, 64);
}
function makeCopilotClaudeModel() {
    return {
...
describe("OpenAI to Anthropic session migration for Copilot Claude", () => {
    ...
    it("removes thoughtSignature from tool calls when migrating between models", () => {
        ...
        const result = transformMessages(messages, model, anthropicNormalizeToolCallId);
        const assistantMsg = result.find((m) => m.role === "assistant");
        const toolCall = assistantMsg.content.find((b) => b.type === "toolCall");
...
//# sourceMappingURL=transform-messages-copilot-openai-to-anthropic.test.js.map