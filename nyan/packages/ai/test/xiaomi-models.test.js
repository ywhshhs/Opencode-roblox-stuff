...
describe("Xiaomi MiMo models", () => {
    ...
    it.each(["xiaomi-token-plan-cn", "xiaomi-token-plan-ams", "xiaomi-token-plan-sgp"])("omits mimo-v2-flash from %s", (provider) => {
        expect(getModels(provider).some((model) => model.id === "mimo-v2-flash")).toBe(false);
    });
});
//# sourceMappingURL=xiaomi-models.test.js.map