...
function getCallbackHost() {
    return getProviderEnvValue("NYAN_OAUTH_CALLBACK_HOST") || "127.0.0.1";
}
...
async function createAuthorizationFlow(originator = "nyan") {
 ...
 * @param options.originator - OAuth originator parameter (defaults to "nyan")
 */
