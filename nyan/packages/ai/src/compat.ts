 ...
 *
 * Existing apps switch imports from "@nyan-works/nyan-ai" to
 * "@nyan-works/nyan-ai/compat" unchanged; new code uses `createModels()`
...
/** @deprecated Static catalog read. Use `getBuiltinModel` from "@nyan-works/nyan-ai/providers/all" or `Models.getModel()`. */
export const getModel = getBuiltinModel;

/** @deprecated Static catalog read. Use `getBuiltinModels` from "@nyan-works/nyan-ai/providers/all" or `Models.getModels()`. */
export const getModels = getBuiltinModels;

/** @deprecated Static catalog read. Use `getBuiltinProviders` from "@nyan-works/nyan-ai/providers/all" or `Models.getProviders()`. */
