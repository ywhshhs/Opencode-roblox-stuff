# @nyan-works/nyan-agent-core

Stateful agent with tool execution and event streaming. Built on `@nyan-works/nyan-ai`.

## Installation

```bash
npm install @nyan-works/nyan-agent-core
```
...
```typescript
declare module "@nyan-works/nyan-agent-core" {
...
```typescript
import { Agent, streamProxy } from "@nyan-works/nyan-agent-core";
...
```typescript
import { agentLoop, agentLoopContinue } from "@nyan-works/nyan-agent-core";
