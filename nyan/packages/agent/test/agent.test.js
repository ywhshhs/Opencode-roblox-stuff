...
function createAssistantToolUseMessage(content) {
    return {
        role: "assistant",
        content,
        api: "openai-responses",
...
describe("Agent", () => {
    ...
    it("should throw when prompt() called while streaming", async () => {
        ...
        await expect(agent.prompt("Second message")).rejects.toThrow("Agent is already processing a prompt. Use steer() or followUp() to queue messages, or wait for completion.");
    ...
    it("should throw when continue() called while streaming", async () => {
        ...
        await expect(agent.continue()).rejects.toThrow("Agent is already processing. Wait for completion before continuing.");
        // Cleanup
        agent.abort();
