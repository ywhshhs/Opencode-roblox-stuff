import type { Api, AssistantMessage, AssistantMessageEvent, AssistantMessageEventStream, Context, ImageContent, Message, Model, SimpleStreamOptions, TextContent, Tool, ToolResultMessage } from "@nyan-works/nyan-ai";
 ...
 * from @nyan-works/nyan-ai to detect support for a concrete model.
 */
