...
import { AuthStorage } from "@nyan-works/nyan-coding-agent";
...
export function getRadiusAccessToken() {
    ...
    throw new Error("Radius credentials are required in ~/.nyan/agent/auth.json or PI_RADIUS_API_KEY");
}
