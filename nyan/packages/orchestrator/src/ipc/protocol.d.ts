...
export type ResponseFor<T extends OrchestratorRequest> = T extends {
    type: infer K;
...
export declare function parseRequestLine(line: string): OrchestratorRequest;
export declare function parseResponseLine(line: string): OrchestratorResponse;
