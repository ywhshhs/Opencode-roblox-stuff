 ...
 */
import { anthropicMessagesApi, createAssistantMessageEventStream, openAIResponsesApi, } from "@nyan-works/nyan-ai/compat";
// =============================================================================
// Constants
// =============================================================================
...
let cachedDirectAccess = null;
async function getDirectAccessToken(gitlabAccessToken) {
    const now = Date.now();
...
async function loginGitLab(callbacks) {
...
async function refreshGitLabToken(credentials) {
