 ...
 */
import { isKeyRelease } from "@nyan-works/nyan-tui";
import { DoomKeys, mapKeyToDoom } from "./doom-keys.js";
function renderHalfBlock(rgba, width, height, targetCols, targetRows) {
    const lines = [];
...
export class DoomOverlayComponent {
    constructor(tui, engine, onExit, resume = false) {
        this.interval = null;
...
//# sourceMappingURL=doom-component.js.map