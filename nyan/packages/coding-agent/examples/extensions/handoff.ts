...
import type { AgentMessage } from "@nyan-works/nyan-agent-core";
import { complete, type Message } from "@nyan-works/nyan-ai/compat";
import type { ExtensionAPI, SessionEntry } from "@nyan-works/nyan-coding-agent";
