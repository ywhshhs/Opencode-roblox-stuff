...
export default function (pi) {
    ...
    pi.registerCommand("timed", {
        ...
        handler: async (_args, ctx) => {
            const confirmed = await ctx.ui.confirm("Timed Confirmation", "This dialog will auto-cancel in 5 seconds. Confirm?", { timeout: 5000 });
            if (confirmed) {
...
//# sourceMappingURL=timed-confirm.js.map