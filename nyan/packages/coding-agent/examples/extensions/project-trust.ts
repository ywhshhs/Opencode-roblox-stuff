 ...
 *
 *   mkdir -p ~/.nyan/agent/extensions
 *   cp packages/coding-agent/examples/extensions/project-trust.ts ~/.nyan/agent/extensions/
 *
 * Or:
 *
...
import type { ExtensionAPI, ProjectTrustEventResult } from "@nyan-works/nyan-coding-agent";
