 ...
 */
import { complete } from "@nyan-works/nyan-ai/compat";
import { BorderedLoader, convertToLlm, serializeConversation } from "@nyan-works/nyan-coding-agent";
        ...
        handler: async (args, ctx) => {
            ...
            const result = await ctx.ui.custom((tui, theme, _kb, done) => {
                ...
                const doGenerate = async () => {
                    ...
                    const response = await complete(ctx.model, { systemPrompt: SYSTEM_PROMPT, messages: [userMessage] }, { apiKey: auth.apiKey, headers: auth.headers, env: auth.env, signal: loader.signal });
