...
import { calculateCost, createAssistantMessageEventStream, } from "@nyan-works/nyan-ai";
// =============================================================================
...
function convertMessages(messages, isOAuth, _tools) {
    const params = [];
...
function convertTools(tools, isOAuth) {
...
function streamCustomAnthropic(model, context, options) {
    ...
    (async () => {
        ...
        try {
            ...
            if (options?.reasoning && model.reasoning) {
                ...
                const customBudget = options.thinkingBudgets?.[options.reasoning];
                params.thinking = {
                    type: "enabled",
