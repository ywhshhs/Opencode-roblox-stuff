import { uuidv7 } from "@nyan-works/nyan-agent-core";
 ...
 * Encodes cwd into a safe directory name under ~/.nyan/agent/sessions/.
 */
...
export class SessionManager {
     ...
     * @param sessionDir Optional session directory. If omitted, uses default (~/.nyan/agent/sessions/<encoded-cwd>/).
     */
