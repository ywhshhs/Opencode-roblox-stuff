...
import type { AgentMessage, StreamFn, ThinkingLevel } from "@nyan-works/nyan-agent-core";
import type { AssistantMessage, Context, Model, SimpleStreamOptions, Usage } from "@nyan-works/nyan-ai/compat";
import { completeSimple } from "@nyan-works/nyan-ai/compat";
import {
	convertToLlm,
