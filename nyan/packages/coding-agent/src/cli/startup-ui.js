import { ProcessTerminal, setKeybindings, TUI } from "@nyan-works/nyan-tui";
...
const OFFICIAL_PACKAGE_NAME = "@nyan-works/nyan-coding-agent";
const OFFICIAL_APP_NAME = "nyan";
const OFFICIAL_CONFIG_DIR_NAME = ".nyan";
 ...
 * - experimental features are enabled (NYAN_EXPERIMENTAL=1)
