...
/**
 * Migrate sessions from ~/.nyan/agent/*.jsonl to proper session directories.
 *
 * Bug in v0.30.0: Sessions were saved to ~/.nyan/agent/ instead of
 * ~/.nyan/agent/sessions/<encoded-cwd>/. This migration moves them
