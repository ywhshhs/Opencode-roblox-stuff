...
const nyanConfigName = pkg.nyanConfig?.name;
export const PACKAGE_NAME = pkg.name || "@nyan-works/nyan-coding-agent";
export const APP_NAME = nyanConfigName || "nyan";
export const APP_TITLE = nyanConfigName ? APP_NAME : "n";
export const CONFIG_DIR_NAME = pkg.nyanConfig?.configDir || ".nyan";
