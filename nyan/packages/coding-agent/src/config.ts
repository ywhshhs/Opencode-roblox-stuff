...
export function getSelfUpdateUnavailableInstruction(
	...
	if (method === "bun-binary") {
		return `Download from: https://github.com/earendil-works/nyan-mono/releases/latest`;
	}
...
export function getPackageDir(): string {
	...
	const envDir = process.env.NYAN_PACKAGE_DIR;
	if (envDir) {
...
// =============================================================================
// App Config (from package.json nyanConfig)
// =============================================================================
...
const nyanConfigName: string | undefined = pkg.nyanConfig?.name;
export const PACKAGE_NAME: string = pkg.name || "@nyan-works/nyan-coding-agent";
export const APP_NAME: string = nyanConfigName || "nyan";
export const APP_TITLE: string = nyanConfigName ? APP_NAME : "n";
export const CONFIG_DIR_NAME: string = pkg.nyanConfig?.configDir || ".nyan";
export const VERSION: string = pkg.version || "0.0.0";

// e.g., NYAN_CODING_AGENT_DIR or TAU_CODING_AGENT_DIR
export const ENV_AGENT_DIR = "NYAN_CODING_AGENT_DIR";
export const ENV_SESSION_DIR = "NYAN_CODING_AGENT_SESSION_DIR";

export function expandTildePath(path: string): string {
	return normalizePath(path);
}

const DEFAULT_SHARE_VIEWER_URL = "https://nyan.dev/session/";

/** Get the share viewer URL for a gist ID */
export function getShareViewerUrl(gistId: string): string {
	const baseUrl = process.env.NYAN_SHARE_VIEWER_URL || DEFAULT_SHARE_VIEWER_URL;
	return `${baseUrl}#${gistId}`;
}

// =============================================================================
// User Config Paths (~/.nyan/agent/*)
// =============================================================================

/** Get the agent config directory (e.g., ~/.nyan/agent/) */
