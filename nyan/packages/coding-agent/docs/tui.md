...
**Source:** [`@nyan-works/nyan-tui`](https://github.com/earendil-works/pi-mono/tree/main/packages/tui)
...
```typescript
import { CURSOR_MARKER, type Component, type Focusable } from "@nyan-works/nyan-tui";
...
```typescript
import { Container, type Focusable, Input } from "@nyan-works/nyan-tui";
...
Import from `@nyan-works/nyan-tui`:

```typescript
import { Text, Box, Container, Spacer, Markdown } from "@nyan-works/nyan-tui";
```
...
```typescript
import { matchesKey, Key } from "@nyan-works/nyan-tui";
...
```typescript
import { visibleWidth, truncateToWidth } from "@nyan-works/nyan-tui";
...
```typescript
import { getMarkdownTheme } from "@nyan-works/nyan-coding-agent";
import { Markdown } from "@nyan-works/nyan-tui";
...
For letting users pick from a list of options. Use `SelectList` from `@nyan-works/nyan-tui` with `DynamicBorder` for framing.

```typescript
import type { ExtensionAPI } from "@nyan-works/nyan-coding-agent";
import { DynamicBorder } from "@nyan-works/nyan-coding-agent";
import { Container, type SelectItem, SelectList, Text } from "@nyan-works/nyan-tui";
...
```typescript
import { BorderedLoader } from "@nyan-works/nyan-coding-agent";
...
For toggling multiple settings. Use `SettingsList` from `@nyan-works/nyan-tui` with `getSettingsListTheme()`.

```typescript
import { getSettingsListTheme } from "@nyan-works/nyan-coding-agent";
import { Container, type SettingItem, SettingsList, Text } from "@nyan-works/nyan-tui";
...
import { matchesKey, truncateToWidth } from "@nyan-works/nyan-tui";
