...
All keyboard shortcuts can be customized via `~/.nyan/agent/keybindings.json`. Each action can be bound to one or more keys.
...
Create `~/.nyan/agent/keybindings.json`:
