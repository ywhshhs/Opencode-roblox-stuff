...
Sessions are saved automatically to `~/.nyan/agent/sessions/`, organized by working directory.
...
- `~/.nyan/agent/AGENTS.md` for global instructions
...
- `.nyan/SYSTEM.md` for a project
- `~/.nyan/agent/SYSTEM.md` globally
...
|----------|-------------|
| `PI_CODING_AGENT_DIR` | Override config directory; default is `~/.nyan/agent` |
