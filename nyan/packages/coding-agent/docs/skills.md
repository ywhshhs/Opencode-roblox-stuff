...
Discovery rules:
- In `~/.nyan/agent/skills/` and `.nyan/skills/`, direct root `.md` files are discovered as individual skills
...
For project-level Claude Code skills, add to `.nyan/settings.json`:
