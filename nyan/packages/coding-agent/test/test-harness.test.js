...
import { createHarness, createHarnessWithExtensions } from "./test-harness.js";
describe("test harness", () => {
    ...
    it("custom usage numbers", async () => {
        ...
        await harness.session.prompt("hi");
        const msg = harness.session.messages.find((m) => m.role === "assistant");
    ...
    it("streams text deltas", async () => {
        ...
        const reconstructed = textDeltas.map((e) => e.assistantMessageEvent.delta).join("");
    ...
    it("streams thinking deltas", async () => {
        ...
        const reconstructed = thinkingDeltas.map((e) => e.assistantMessageEvent.delta).join("");
