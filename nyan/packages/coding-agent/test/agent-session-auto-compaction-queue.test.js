...
describe("AgentSession auto-compaction queue resume", () => {
    ...
    it("should resume after threshold compaction when only agent-level queued messages exist", async () => {
        ...
        const runAutoCompaction = session._runAutoCompaction.bind(session);
    ...
    it("should not compact repeatedly after overflow recovery already attempted", async () => {
        ...
        const runAutoCompactionSpy = vi
            .spyOn(session, "_runAutoCompaction")
            .mockResolvedValue();
        const events = [];
        ...
        const checkCompaction = session._checkCompaction.bind(session);
...
//# sourceMappingURL=agent-session-auto-compaction-queue.test.js.map