...
import { defaultModelPerProvider, findInitialModel, parseModelPattern, resolveCliModel, } from "../src/core/model-resolver.js";
...
describe("resolveCliModel", () => {
    ...
    test("prefers an authenticated exact raw model id over an unauthenticated inferred provider", () => {
        ...
        const registry = {
            ...
            hasConfiguredAuth: (model) => model.provider === "commandcode",
        };
        const result = resolveCliModel({
