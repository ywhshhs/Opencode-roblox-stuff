...
describe("parseFrontmatter", () => {
    ...
    it("throws on invalid YAML frontmatter", () => {
        const input = "---\nfoo: [bar\n---\nBody";
        expect(() => parseFrontmatter(input)).toThrow(/at line 1, column 10/);
    });
    ...
    it("returns original content when frontmatter is missing or unterminated", () => {
        ...
        const resultNoFrontmatter = parseFrontmatter(noFrontmatter);
        const resultMissingEnd = parseFrontmatter(missingEnd);
