...
function createAssistantMessage(text, totalTokens, timestamp) {
    return {
        role: "assistant",
...
function syncAgentMessages(session, sessionManager) {
...
//# sourceMappingURL=agent-session-stats.test.js.map