...
describe("SettingsManager", () => {
    ...
    describe("project trust", () => {
        ...
        it("should fail project settings writes when project is not trusted", async () => {
            ...
            const manager = SettingsManager.create(projectDir, agentDir, { projectTrusted: false });
            expect(() => manager.setProjectPackages(["npm:new"])).toThrow("Project is not trusted; refusing to write project settings");
            await manager.flush();
            expect(manager.getProjectSettings()).toEqual({});
    ...
    describe("externalEditor", () => {
        ...
        function setEditorEnv(visual, editor) {
            if (visual === undefined)
        ...
        it("should resolve editor commands by precedence", () => {
            ...
            expect(SettingsManager.inMemory({ externalEditor: "code --wait" }).getExternalEditorCommand()).toBe("code --wait");
