...
describe("built-in edit and write tools", () => {
    ...
    it("keeps edit queue locked while an aborted edit write is still in flight", async () => {
        ...
        const controller = new AbortController();
        const firstEdit = editTool.execute("call-1", { path: filePath, edits: [{ oldText: "alpha", newText: "ALPHA" }] }, controller.signal);
        await firstWriteStarted.promise;
        controller.abort();
...
//# sourceMappingURL=file-mutation-queue.test.js.map