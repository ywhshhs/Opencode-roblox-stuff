...
function createAssistantMessage(text, overrides) {
    return {
        role: "assistant",
...
describe("AgentSession retry", () => {
    ...
    function createSession(options) {
        ...
        if (delayAssistantMessageEndMs > 0) {
            const sessionWithHook = session;
            const original = sessionWithHook._emitExtensionEvent.bind(sessionWithHook);
            sessionWithHook._emitExtensionEvent = async (event) => {
...
//# sourceMappingURL=agent-session-retry.test.js.map