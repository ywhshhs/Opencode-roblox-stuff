...
import { highlightCode, initTheme } from "../src/modes/interactive/theme/theme.js";
...
describe("syntax highlight renderer", () => {
    ...
    it("inherits parent formatting for unmapped nested scopes", () => {
        ...
        const rendered = renderHighlightedHtml(`<span class="hljs-string">a<span class="hljs-subst">${interpolation}</span>b</span>`, {
...
//# sourceMappingURL=syntax-highlight.test.js.map