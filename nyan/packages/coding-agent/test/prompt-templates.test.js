...
import { expandPromptTemplate, loadPromptTemplates, parseCommandArgs, substituteArgs, } from "../src/core/prompt-templates.js";
// ============================================================================
// substituteArgs
// ============================================================================
describe("substituteArgs", () => {
    ...
    test("should handle mixed numbered and wildcard placeholders", () => {
        expect(substituteArgs("$1: $@ ($ARGUMENTS)", ["first", "second", "third"])).toBe("first: first second third (first second third)");
    });
...
describe("substituteArgs - array slicing", () => {
    ...
    test("should combine positional, slice, and wildcard placeholders", () => {
        ...
        expect(substituteArgs(template, args)).toBe("Run eslint on file1.ts file2.ts, then process eslint file1.ts file2.ts file3.ts");
    });
