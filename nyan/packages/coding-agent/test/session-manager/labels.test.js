...
describe("SessionManager labels", () => {
    it("sets and gets labels", () => {
        ...
        const labelEntry = entries.find((e) => e.type === "label");
    ...
    it("last label wins", () => {
        ...
        const entries = session.getEntries();
        const lastLabelEntry = entries.find((e) => e.id === lastLabelId);
    ...
    it("labels are included in tree nodes", () => {
        ...
        const entries = session.getEntries();
        const msg1LabelEntry = entries.find((e) => e.id === msg1LabelId);
        const msg2LabelEntry = entries.find((e) => e.id === msg2LabelId);
        const tree = session.getTree();
    ...
    it("labels are preserved in createBranchedSession", () => {
        ...
        const msg1LabelEntry = originalEntries.find((e) => e.id === msg1LabelId);
        const msg2LabelEntry = originalEntries.find((e) => e.id === msg2LabelId);
