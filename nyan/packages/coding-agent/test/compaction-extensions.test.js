...
const ANYAN_KEY = process.env.ANTHROPIC_OAUTH_TOKEN || process.env.ANTHROPIC_ANYAN_KEY;
describe.skipIf(!ANYAN_KEY)("Compaction extensions", () => {
    let session;
    let tempDir;
    let capturedEvents;
    beforeEach(() => {
    ...
    function createExtension(onBeforeCompact, onCompact) {
    ...
    function createSession(extensions) {
...
//# sourceMappingURL=compaction-extensions.test.js.map