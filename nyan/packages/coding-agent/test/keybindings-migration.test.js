...
describe("keybindings migration", () => {
    ...
    function createAgentDir(config) {
    ...
    it("rewrites old key names to namespaced ids", () => {
        ...
        const migrated = JSON.parse(fs.readFileSync(path.join(agentDir, "keybindings.json"), "utf-8"));
...
//# sourceMappingURL=keybindings-migration.test.js.map