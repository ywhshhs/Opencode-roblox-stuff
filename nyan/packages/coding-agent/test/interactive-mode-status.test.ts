...
import { type AutocompleteProvider, CombinedAutocompleteProvider } from "@nyan-works/nyan-tui";
		...
		return [
			...
			},
			{
				...
				sourceInfo: createSourceInfo(
					"/tmp/project/.nyan/git/github.com/HazAT/pi-interactive-subagents/extensions/index.ts",
					{
			...
			},
			{
				...
				sourceInfo: createSourceInfo(
					"/tmp/project/.nyan/git/github.com/HazAT/pi-interactive-subagents/extensions/subagents/index.ts",
					{
						source: "git:github.com/HazAT/pi-interactive-subagents",
						scope: "project",
						origin: "package",
