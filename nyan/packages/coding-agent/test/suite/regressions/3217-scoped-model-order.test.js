...
describe("issue #3217 scoped model ordering", () => {
    ...
    it("preserves scoped model order in the /model scoped tab", async () => {
        ...
        const selector = new ModelSelectorComponent(createFakeTui(), modelOne, harness.settingsManager, harness.session.modelRegistry, [{ model: modelTwo }, { model: modelOne }, { model: modelThree }], () => { }, () => { });
...
//# sourceMappingURL=3217-scoped-model-order.test.js.map