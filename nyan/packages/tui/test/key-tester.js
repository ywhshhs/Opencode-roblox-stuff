...
import { truncateToWidth } from "../src/utils.js";
/**
 * Simple key code logger component
 */
class KeyLogger {
    constructor(tui, terminal) {
        this.log = [];
        this.maxLines = 20;
        this.tui = tui;
    ...
    protocolName() {
        if (this.terminal.kittyProtocolActive)
            return "kitty";
        if (this.terminal.modifyOtherKeysActive)
...
//# sourceMappingURL=key-tester.js.map