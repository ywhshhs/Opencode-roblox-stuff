...
import { extractSegments, sliceWithWidth, visibleWidth } from "../src/utils.js";
describe("tab width accounting", () => {
    it("keeps slice helper widths consistent with visible width", () => {
        const text = "out 192M\t.nyan/skill-tests/results-ha";
...
//# sourceMappingURL=tab-width.test.js.map