...
import { deleteAllKittyImages, deleteKittyImage, detectCapabilities, encodeKitty, hyperlink, isImageLine, renderImage, resetCapabilitiesCache, setCapabilities, setCellDimensions, } from "../src/terminal-image.js";
const ENV_KEYS = [
    "TERM",
    "TERM_PROGRAM",
    "TERMINAL_EMULATOR",
...
describe("isImageLine", () => {
    describe("iTerm2 image protocol", () => {
        ...
        it("should detect iTerm2 image escape sequence in middle of long line", () => {
            ...
            const longLineWithImage = "Text before image..." + "\x1b]1337;File=inline=1:verylongbase64data==" + "...text after";
...
describe("Kitty image cursor movement", () => {
    ...
    it("caps Image component height to a square pixel box by default", () => {
        ...
        try {
            const image = new Image("AAAA", "image/png", { fallbackColor: (value) => value }, { maxWidthCells: 10 }, { widthPx: 10, heightPx: 100 });
    ...
    it("places image sequence on first line with empty padding rows", () => {
        ...
        setCellDimensions({ widthPx: 10, heightPx: 10 });
        try {
            const image = new Image("AAAA", "image/png", { fallbackColor: (value) => value }, { maxWidthCells: 2 }, { widthPx: 20, heightPx: 20 });
...
//# sourceMappingURL=terminal-image.test.js.map