...
describe("regional indicator width regression", () => {
    ...
    it("treats all regional-indicator singleton graphemes as width 2", () => {
        for (let cp = 0x1f1e6; cp <= 0x1f1ff; cp++) {
            ...
            assert.strictEqual(visibleWidth(regionalIndicator), 2, `Expected ${regionalIndicator} (U+${cp.toString(16).toUpperCase()}) to be width 2`);
        }
    });
...
//# sourceMappingURL=regression-regional-indicator-width.test.js.map