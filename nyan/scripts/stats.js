...
function addUsage(totals, usage, sessionFile) {
...
Options:
  ...
  --sessions-base <path>    Sessions base directory (default: ~/.nyan/agent/sessions)
...
function printTotals(label, totals) {
    console.log(`${label.padEnd(16)} messages: ${String(totals.assistantMessages).padStart(5)}  sessions: ${String(totals.sessions.size).padStart(3)}  ` +
