...
import { parseSessionEntries } from "../packages/coding-agent/src/core/session-manager.js";
                ...
                if (event.type === "message_update" && event.assistantMessageEvent) {
                    ...
                    if (event.args) {
                        if (event.toolName === "read") {
                            ...
                            if (event.args.offset)
                                argsStr += ` offset=${event.args.offset}`;
                            if (event.args.limit)
                                argsStr += ` limit=${event.args.limit}`;
                        }
...
async function main() {
    ...
    const sessionsBase = join(homedir(), ".nyan/agent/sessions");
...
//# sourceMappingURL=session-transcripts.js.map